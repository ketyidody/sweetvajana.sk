<template>
  ...
  <div class="min-h-screen flex flex-col bg-background">
    ...
    <main class="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <h1 class="text-3xl md:text-4xl mb-8">Checkout</h1>
          ...
          <form @submit.prevent="submitOrder" class="space-y-6">
            <div class="bg-card rounded-lg border border-border p-6">
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label for="notes" class="block text-sm font-medium mb-1">Order Notes <span class="text-muted-foreground">(optional)</span></label>
                  <textarea
                    id="notes"
                    v-model="form.notes"
                    rows="2"
